    ...
    public partial class frmSatis : Form
    {
        ...
        void Kaydet()
        {
            if (txtEvrakNo.Text != "" && txtTutar.Text != "" && id == -1)
            {
                ...
                OleDbCommand cmd = new OleDbCommand("INSERT INTO Satislar(MusteriID,EvrakNo,Tarih,Vade,AciklamaID,Miktar,BirimID,Fiyat,Tutar,Tur,SonBakiye) VALUES(@MusteriID,@EvrakNo,@Tarih,@Vade,@AciklamaID,@Miktar,@BirimID,@Fiyat,@Tutar,1,@SonBakiye)", conn);
