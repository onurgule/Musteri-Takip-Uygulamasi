    ...
    public partial class frmAlis : Form
    {
        ...
        void Kaydet()
        {
            if (txtEvrakNo.Text != "" && txtTutar.Text != "" && id == -1)
            {
                ...
                OleDbCommand cmd = new OleDbCommand("INSERT INTO Alislar(MusteriID,EvrakNo,Tarih,Vade,AciklamaID,Miktar,BirimID,Fiyat,Tutar,Tur,SonBakiye) VALUES(@MusteriID,@EvrakNo,@Tarih,@Vade,@AciklamaID,@Miktar,@BirimID,@Fiyat,@Tutar,0,@SonBakiye)", conn);
                ...
                cmd.Parameters.Add("@SonBakiye", OleDbType.Double).Value = ilkbakiye - Convert.ToDouble(txtMiktar.Text) * Convert.ToDouble(txtFiyat.Text);
        ...
        private void frmAlis_FormClosing(object sender, FormClosingEventArgs e)
        {
